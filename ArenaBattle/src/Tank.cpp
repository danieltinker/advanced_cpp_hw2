...
// applyAction(...) is just a stub here, because most legal‐move logic
// is handled by GameState/GameManager. If you want to move the tank
// yourself here, implement it accordingly.